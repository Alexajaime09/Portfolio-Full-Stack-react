...
const HeroSection = () => {
  ...
  return (
    <div className="bg-bg w-full h-full grid  grid-cols-1 p-8  md:grid-cols-[1.35fr_0.65fr] gap-y-[80px]   ">
      <div className=" flex flex-col justify-center items-start  order-2 md:order-1 ">
        <h1 className="text-[60px] md:text-[90px] lg:text-[120px] text-white font-secondary font-bold ">
          {headline}
        </h1>
        ...
        <div>
          {ctas.map((button) => (
            <button className=" text-white " key={button.label}>
              {button.label}
            </button>
          ))}
        </div>
