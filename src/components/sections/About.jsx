...
const About = () => {
  ...
  return (
    <div className=" w-full min-h-full flex flex-col  items-center justify-center bg-[rgb(12,12,12)] relative gap-8 ">
      <h3 className=" text-white text-[35px] md:text-[48px] lg:text-[63px]  font-normal font-main  ">
        {title}
      </h3>
      <div className=" w-[90%] min-h-full flex flex-col md:flex-row items-center justify-center gap-y-4 md:gap-x-7 border border-white rounded-3xl py-4 ">
